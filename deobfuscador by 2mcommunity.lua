...
t2.value66.Name = "DPSTOREThemeButton"
...
t2.value19.Name = "DPSTOREHitboxTouchBtn"
...
local function v68()
    ...
    for v263, v264 in ipairs(t2.value38:GetDescendants()) do
        ...
        local v265 = v264.Name == "DPSTOREThemeButton"
...
TextButton.Text = "🔗 https://discord.gg/FFzXFVqT54"
TextButton.TextColor3 = Color3.fromRGB(255, 255, 255)
TextButton.TextSize = 12
TextButton.Font = Enum.Font.GothamBold
...
t2.value21("✅ DP STORE | BY: Parker Goat")
print("✅ DP STORE HUB - Carregado com sucesso.")
